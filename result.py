...
class resultClass:
    def __init__(self,root):
        ...
        #button
        bt_add=Button(self.root,text="Submit",font=("times new roman",15),bg="lightgreen",activebackground="lightgreen",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        bt_clear=Button(self.root,text="Clear",font=("times new roman",15),bg="lightgreen",activebackground="lightgray",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
        
        #image
        self.bg_img=Image.open("images/result.jpg")
        self.bg_img=ImageTk.PhotoImage(self.bg_img)
        self.lbl_bg=Label(self.root,image=self.bg_img).place(x=650,y=100,width=500,height=320)
